...
Window_Options.prototype.addKeyConfigCommand = function() {
	...
	this.addCommand($w.getText('KeyConfig'), 'keyConfig', true);
};
...
Window_KeyConfig.prototype.makeCommandList = function(index) {
		...
		this.addCommand($w.getText('KeyConfigDefault'), 'default', true);
		for (var i = 0; i < 6; ++i) this.addCommand(' ', 'default', true);
		this.addCommand($w.getText('KeyConfigLayout'), 'wasd', true);
		for (var i = 0; i < 6; ++i) this.addCommand(' ', 'wasd', true);
		this.addCommand($w.getText('KeyConfigFinish'), 'cancel', true);
...
Window_KeyConfig.prototype.updateHelp = function() {
    if (!this._helpWindow) return;
		...
		case 'key':
			this._helpWindow.setText($w.getText('KeyConfigHelp'));
			break;
		case 'default':
			this._helpWindow.setText($w.getText('KeyConfigDefaultHelp'));
			break;
		case 'wasd':
			this._helpWindow.setText($w.getText('KeyConfigLayoutHelp'));
			break;
		case 'cancel':
			this._helpWindow.setText($w.getText('KeyConfigFinishHelp'));
			break;
		default:
...
Window_KeyAction.prototype.makeCommandList = function() {
	this.addCommand($w.getText('KeyConfigButtonClear'), 'ok', true, 'clear');
	this.addCommand($w.getText('KeyConfigButtonOk'), 'ok', true, 'ok');
	this.addCommand($w.getText('KeyConfigButtonEsc'), 'ok', true, 'escape');
	this.addCommand($w.getText('KeyConfigButtonCancel'), 'ok', true, 'cancel');
	this.addCommand($w.getText('KeyConfigButtonMenu'), 'ok', true, 'menu');
	this.addCommand($w.getText('KeyConfigButtonDash'), 'ok', true, 'shift');
	this.addCommand($w.getText('KeyConfigButtonPageUp'), 'ok', true, 'pageup');
	this.addCommand($w.getText('KeyConfigButtonPageDown'), 'ok', true, 'pagedown');
	this.addCommand($w.getText('KeyConfigButtonLeft'), 'ok', true, 'left');
	this.addCommand($w.getText('KeyConfigButtonUp'), 'ok', true, 'up');
	this.addCommand($w.getText('KeyConfigButtonRight'), 'ok', true, 'right');
	this.addCommand($w.getText('KeyConfigButtonDown'), 'ok', true, 'down');
	this.addCommand($w.getText('KeySkip'), 'ok', true, 'skip');
	this.addCommand($w.getText('KeyMimicry'), 'ok', true, 'mimicry');
	this.addCommand($w.getText('KeyWardrobe'), 'ok', true, 'wardrobe');
};
